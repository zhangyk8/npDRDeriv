...
for n in n_lst:
    ...
    for fac in fac_lst:
        ...
        theta_C_IPW1, condTS1 = IPWDRDerivBC(Y=Y_sim, X=X_dat, t_eval=t_qry, L=1, h=h, 
                                             kern='epanechnikov', b=None, self_norm=True, thres_val=0.5)
        ...
        theta_C_DR5, theta_C_sd5 = DRDRDerivBC(Y=Y_sim, X=X_dat, t_eval=t_qry, mu=NeurNet, 
                                               ...
                                               b=None, thres_val=0.7, self_norm=True)
        
        with open('./Results/Sim1_Nopos_theta_'+str(job_id)+'_n_'+str(n)+'_h'+str(fac)+'_inner_selfnorm.dat', "wb") as file:
