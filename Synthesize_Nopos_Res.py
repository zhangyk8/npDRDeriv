...
for fac in fac_lst:
    ...
    for b in range(1, B+1):
        with open('./Results/Sim1_Nopos_theta_'+str(b)+'_h'+str(fac)+'_selfnorm3.dat', "rb") as file:
    ...
    with open('./Syn_Results/Sim1_Nopos_theta_h'+str(fac)+'_selfnorm3.dat', "wb") as file:
